...
The V3 entry point is `tools/run_m710id70_v3.py`. V2 remains a historical
entry point; reproducing its exact numeric results requires the reference
commit, because shared math fixes intentionally change its imported code.
